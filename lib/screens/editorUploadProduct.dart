...
import 'package:ecommerce_flutter_admin1/constans/validator.dart';
import 'package:ecommerce_flutter_admin1/models/product_model.dart';
import 'package:ecommerce_flutter_admin1/services/myapp_functions.dart';
import 'package:ecommerce_flutter_admin1/widget/loader_manager.dart';
...
class _EditorUploadProductScreenState extends State<EditorUploadProductScreen> {
  ...
  Future<void> _addProduct() async{
    if(_pickedImage == null){
      MyAppFunctions.showErrorOrWaningDialog(
        context: context, subtitle: "Lütfen resim giriniz", fct: (){},
    ...
    if(isValid){
      ...
      try{
        ...
        Fluttertoast.showToast(msg: "Ürün başarı ile eklendi", textColor: Colors.red);
        if(!mounted) return;
        MyAppFunctions.showErrorOrWaningDialog(
            context: context,
            subtitle: "Ekran temizlensin mi? ? ",
            fct: (){
              clearForm();
            });
  ...
  Future<void> _editProduct() async{
    ...
    if(_pickedImage == null){
      MyAppFunctions.showErrorOrWaningDialog(
        context: context, subtitle: "Lütfen resim seçiniz", fct: (){},
    ...
    return  GestureDetector(
      ...
      child: Scaffold(
                ...
                Row(
                  ...
                  children: [
                    ...
                    ElevatedButton.icon(
                      ...
                      icon: const Icon(Icons.clear),
                      label:  Text(isEditing ? "Ürünü Kaydet" : "Ürün Ekle" ),
        ...
        appBar: AppBar(
            ...
            title:  TitleTextWidget(label: isEditing ? "Ürün" : "Yeni Ürün")
        ),
                      ...
                      child: Column(
                        children: [
                          TextFormField(
                            ...
                            validator: (value){
                              return MyValidators.uploadProdText(
                                  value: value,
                                  toBeReturnedString: "Lütfen bir başlık giriniz"
                              );
                            },
                            ...
                            children: [
                              Flexible(
                                ...
                                child:  TextFormField(
                                  ...
                                  key: const ValueKey('Ücret \TL'),

                                  keyboardType: TextInputType.number,
                                  decoration: const InputDecoration(
                                      hintText: "Ücret",
                                      prefix:  SubTitleTextWidget(label: "\TL  ",
                                        color: Colors.blue,
                                        fontSize: 15,
                                      )
                                  ),
                                  validator: (value){
                                    return MyValidators.uploadProdText(
                                        value: value,
                                        toBeReturnedString: "Lütfen eksik olanı girin"
                                    );
                                  },
                              ...
                              Flexible(
                                ...
                                child:  TextFormField(
                                  ...
                                  key: const ValueKey('Miktar'),

                                  keyboardType: TextInputType.number,
                                  textInputAction: TextInputAction.newline,
                                  decoration: const InputDecoration(
                                      hintText: "Miktar",
                                      prefix:  SubTitleTextWidget(label: "Adet : ",
                                        color: Colors.blue,
                                        fontSize: 15,
                                      )
                                  ),
                                  validator: (value){
                                    return MyValidators.uploadProdText(
                                        value: value,
                                        toBeReturnedString: "Eksik miktarı giriniz"
                                    );
                                  },
                          ...
                          TextFormField(
                            ...
                            keyboardType: TextInputType.multiline,
                            decoration: const InputDecoration(
                              hintText: "Ürün özellikleri",
                            ),
                            validator: (value){
                              return MyValidators.uploadProdText(
                                  value: value,
                                  toBeReturnedString: "Açıklama sorunu"
                              );
                            },
